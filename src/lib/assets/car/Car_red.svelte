...
Command: npx @threlte/gltf@1.0.1 static/car_red.gltf
-->
...
<script>
  ...
  const gltf = useGltf('/static/car_red.gltf')
  ...
  {:then gltf}
    <T.Group name="Scene">
      <T.Group name="body" position={[0, -0.05, 0]}>
        ...
        <T.Mesh name="Mesh_1" geometry={gltf.nodes.Mesh_1.geometry} material={gltf.materials.hl_glass} />
        <T.Mesh name="Mesh_2" geometry={gltf.nodes.Mesh_2.geometry} material={gltf.materials.mirrors} />
        <T.Mesh name="Mesh_3" geometry={gltf.nodes.Mesh_3.geometry} material={gltf.materials.windows} />
        <T.Mesh name="Mesh_4" geometry={gltf.nodes.Mesh_4.geometry} material={gltf.materials.body} />
      </T.Group>
      <T.Mesh
        name="leds_f"
